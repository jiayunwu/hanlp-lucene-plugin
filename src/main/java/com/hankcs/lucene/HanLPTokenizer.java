...
/*    // 当前词
     ...
     */
    public HanLPTokenizer(Segment segment, Set<String> filter, boolean enablePorterStemming, Reader input) {
        super(input);
    ...
    final public boolean incrementToken() throws IOException {
        ...
        if (term != null) {
            ...
            termAttribute.setTermBuffer(term.word);
            termAttribute.setTermLength(term.word.length());
